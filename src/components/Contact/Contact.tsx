...
return (
    ...
    <div className={`contact__text ${show ? "show" : ""}`}>I am now looking for an internship where I will have the chance to develop my technical skills and gain practical experience with support and tutoring. Do you think we could be a good match? Email me at fannie.wallner@medieinstitutet.se or connect with me on LinkedIn</div>
        ...
        <Socials url="https://github.com/fanniewallner" iconlink={<FaGithub style={iconStyles}/>}></Socials>
    <Socials url="https://www.linkedin.com/in/fannie-wallner-87635b239/" iconlink={<FaLinkedin style={iconStyles}/>}></Socials>
    <Socials url="https://www.dropbox.com/s/ptstl2tu2o5g134/Fannie%20Wallner.pdf?dl=0" iconlink={<BsPersonVcardFill style={iconStyles}/>}></Socials>
        </div>
    </div>
    </>
)
